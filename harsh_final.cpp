...
class check {
	...
	bool check_student(int roll,int pass){
		...
		bool check_teacher(int roll,int pass){
			fstream file;
			file.open("bin/recruiter.txt", ios:: in );
			if (!file) {
				cout << "Something went wrong Try again...";
...
class date_sheet {
	...
	class admin: public first,public check,public auth,public date_sheet {
		...
		do{
			...
			cout << "Enter Recruiter Name: ";
			cin >> teacher_name;
			cout << "Enter Recruiter email: ";
			cin >> teacher_email;
			cout << "Enter Recruiter Subect: ";
			...
			cout << "Enter Recruiter Code : ";
			cin >> teach_Code;

			ofstream teacher;
			teacher.open("bin/recruiter.txt", ios::app);
			if (!teacher) {
